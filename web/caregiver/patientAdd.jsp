                            ...
                            <div class=" col-md-9 col-lg-9 ">
                                <table class="table table-user-information">
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="number" class="form-control" name="user_contact" value="" placeholder="Enter Contact Number" required></td>
                                    </tr>
                                    <tr>
                                        <td>Address</td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <textarea class="form-control" name="user_condition" id="userCondition" rows="4" required></textarea> <br>
                                        </td>
                                    </tr>
