                    ...
                    <div class="panel-body">
                        <div class="container">
                            ...
                            <div class="col-md-3 col-lg-3 " align="center">
                                <br>
                                <img alt="User Pic" style="width: 250px;height: 250px" src="https://d30y9cdsu7xlg0.cloudfront.net/png/5832-200.png" class="img-circle img-responsive">
                            </div>

                            <form action="/UserServlet" method="post">
                                <div class=" col-md-8 col-lg-8 ">
                                    <input type="hidden" style="font-weight: bolder" class="form-control" name="route" id="route"placeholder="" value="edit">
                                    <input type="hidden" style="font-weight: bolder" class="form-control" name="roleA" id="roleA"placeholder="" value="caregiver">
