                        ...
                        <div class="row">
                            ...
                            <div class=" col-md-9 col-lg-9 ">
                                <table class="table table-user-information">
                                    ...
                                    <tr>
                                        <td>Name:</td>
                                        <td><input type="text" class="form-control" id="user_name" value="Umar (hardcoded for now)" placeholder="Enter Medicine Name"></td>
                                    </tr>
                                    <tr>
                                        <td>NRIC:</td>
                                        <td><input type="text" class="form-control" id="user_NRIC" value="S9318913X" placeholder="Enter Brand"></td>
                                    </tr>
                                    <tr>
                                        <td>Email</td>
                                        <td><input type="email" class="form-control" id="user_email" value="Juoae@gmail.com" placeholder="Enter Price"></td>
                                    </tr>
